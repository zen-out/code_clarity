const { see, hourglass } = require("./index.js")
    // let notify = getLogger("notifyLogger")
    //     // original logger
...
see.step("step")
hourglass.start("hi")
hourglass.end("finished with module")

// see.story("users will be able to track start and stop time")
// see.problem("json formatting is terrible")